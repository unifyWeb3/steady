export const REDEMPTION_STATES = Object.freeze(["READY", "SUBMITTING", "UNKNOWN", "CONFIRMED", "FAILED", "REDEEMED"]);

export function redemptionButtonDisabled(state) {
  return state === "SUBMITTING" || state === "UNKNOWN" || state === "CONFIRMED" || state === "REDEEMED";
}
